...
const htmlStructure = ({ client, users, sale, body }) => {
      ...
      <div id="page_pdf">
        ...
        <table id="factura_detalle">
          ...
          ${products.map((product) => {
            ...
            <td class="textcenter">${product.description}</td>
...
const createPdf = async (body, client, users, _id, sale, res) => {
  await pdf
    .create(htmlStructure({ client, users, sale, body }), {})
